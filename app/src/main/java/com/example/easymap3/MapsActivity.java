        ...
        GoogleMap.OnMarkerClickListener
{
    ...
    private String getUrl(double latitude, double longitude, String place)
    {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyCJxKFq_41wfmbkxgvB7jw2t56okW0GSIQ");
    ...
    public void shareClick(View view) {
        ...
        Call<ServerResponse> call=apiInterface.shareLocation(email,password,latitude,longitude,"active");
        call.enqueue(new Callback<ServerResponse>() {
            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                ...
                if(message.equals("update")){
                    Toast.makeText(MapsActivity.this, "Your Location is shared", Toast.LENGTH_LONG).show();
